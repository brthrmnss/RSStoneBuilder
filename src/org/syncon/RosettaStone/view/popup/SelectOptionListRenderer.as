package  org.syncon.RosettaStone.view.popup
{
	...
	public class SelectOptionListRenderer extends  BaseRenderer
	{
		//--------------------------------------------------------------------------
		...
		public function SelectOptionListRenderer()
		{
			percentWidth = 100;
		}
		...
		override protected function createChildren():void
		{
			...
			baseColor = uint( this.txtTitle.defaultTextFormat.color )
			/*
			cb = new CheckBox();
			cb.width = 48
			cb.height = 48 
		...
		protected function setBackground():void
		{
			...
			if ( this.selected  ) 
			{
				...
				graphics.lineStyle();
				graphics.drawRect(0, 0, this.layoutWidth, layoutHeight);
				graphics.endFill();
				this.arrange.color( this.txtTitle, 0xFFFFFF ) 
				this.setValues();
			}
			else
			{
				if ( this.arrange != null )  
					this.arrange.color( this.txtTitle,  this.baseColor  ) 
				graphics.clear(); 
		...
		//		this.arrange.left( this.cb, unscaledWidth ) ; 
			...
			this.layoutWidth = unscaledWidth
