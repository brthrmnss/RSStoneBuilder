		...
		public function TextAreaSkin()
		{
			...
			switch (applicationDPI)
			{
				...
				default:
				{
					...
					borderClass = org.syncon.odb.view.mobile.TextInput_border
			}
		}
												   ...
												   unscaledHeight:Number):void
		{
			...
			if (invalidateCaretPosition)
			{
				...
				if (!caretBounds)
				{
					...
					{
						trace('Error: Error #2009: This method cannot be used on a text field with a style sheet.'+'\n'+
	'at flash.text::TextField/replaceText()', 'set the text again' )
					}
				}
