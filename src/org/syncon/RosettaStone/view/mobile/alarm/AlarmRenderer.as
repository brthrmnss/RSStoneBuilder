package  org.syncon.RosettaStone.view.mobile.alarm
{
	...
	public class AlarmRenderer extends  BaseRenderer
	{
		//--------------------------------------------------------------------------
		...
		override protected function createChildren():void
		{
			...
			this.txtTime  = TextUtil.createSimpleTextField( getStyle( "txtAlarmTimeStyle" ) , false, "none" );
			...
			this.txtName  = TextUtil.createSimpleTextField( getStyle( "txtAlarmNameStyle" ) , false, "none" );
			this.arrange.oneline( this.txtName )
			this.arrange.fontSize( this.txtName, 24  )
			this.arrange.useEmbeddedFont( this.txtName )
			addChild( this.txtName );
			
			this.txtRepeat  = TextUtil.createSimpleTextField( getStyle( "txtAlarmRepeatStyle" ) , false, "none" );
		...
		override protected function updateDisplayList( unscaledWidth:Number, unscaledHeight:Number ):void
		{
			...
			this.arrange.setWidthTo(  unscaledWidth, [ this.txtTime, this.txtRepeat ] );
		...
		{
			var alarm :    AlarmVO = data as AlarmVO; 
			if ( alarm == null )
			{
				return;
			}
			...
			this.txtRepeat.text = 'Never Repeat'; 
			this.txtTime.text = dd.format(  alarm.time ) ; 
			...
			this.cb.selected  = alarm.enabled; 
