package org.syncon.RosettaStone.view.mobile.itemrenderers.utils
{
	...
	//import filters.CSSDropShadowFilter;
	...
	public class TextUtil
	{
		...
		public static function readTextFormat( client:Object, includeAll:Boolean = false ):TextFormat
		{
			...
			if ( client == null ) 
			{
				trace('readTextFormat','client null' ) ; 
				return textFormat
			}
