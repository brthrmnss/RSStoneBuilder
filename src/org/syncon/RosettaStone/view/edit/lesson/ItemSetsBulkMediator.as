package  org.syncon.RosettaStone.view.edit.lesson
{
	...
	import org.syncon.RosettaStone.view.edit.ItemPromptViewer;
	import org.syncon.RosettaStone.vo.LessonItemVO;
	import org.syncon.RosettaStone.vo.LessonSetVO;
	
	public class ItemSetsBulkMediator extends Mediator 
	{
		[Inject] public var ui :ItemSetsBulk;
		...
		override public function onRegister():void
		{
			...
			*/
			this.ui.addEventListener( ItemSetsBulk.DELETE_DATE, this.onDeleteDate ) 
			this.ui.addEventListener( ItemSetsBulk.EDIT_DATE, this.onEditDate ) 
			this.ui.addEventListener( ItemSetsBulk.REFRESH_DATES, this.onRefreshDates ) 				
			this.ui.addEventListener( ItemSetsBulk.ADD_DATE, this.onAddDate ) 
			this.ui.addEventListener( ItemSetsBulk.SAVE_FILE, this.onSave ) 		
